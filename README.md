...
The player has to guess the hidden word letter by letter before all chances are exhausted.
...
Correct guesses reveal the letter position.
Wrong guesses reduce your remaining attempts.
The game ends when:
You guess the complete word 🎉
